...
class RedoTaskScene extends Component {
	...
	constructor(props) {
	  	...
	  	fetch(Config.SERVER_URL + '/mark_redo_task/', 
               {method: 'POST',
                headers: {
	  	...
	  	return (
	  		<View style={styles.container}>
	  		  <View style={styles.textWrapper}>
		          ...
		          Job : Redo {this.props.store} Inventory Check
		          </Text>
		      </View>
		      <View style={styles.taskWrapper}>
		  		  ...
		  		  <View style={styles.taskItem}>
		  		    ...
		  		    <TextInput style={styles.textInput}
				          ...
				          defaultValue={this.props.on_stock_count} />
				  </View>
				  <View style={styles.taskItem}>
				      <Text style={styles.fieldName}>
				      Closest Due
